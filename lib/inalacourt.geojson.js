  ...
  var handlers = {
        ...
        this.data = function ( data ) {
          ...
          return {
            ...
            properties : {
              ...
              transmitted : new Date ( item.transmitted ).getTime ()
            }
          }
        };
        this.close = function () {
    ...
    identity : (function () {
      function Unknown () {
        ...
        this.data = function ( data ) {
          return { id: data.deviceID, name: data.assetRegn, type: data.assetType };
        };
        this.close = function () {
          return "]";
        };
    ...
    multipoint : (function () {
      function MultiPoint () {
        ...
        this.data = function ( data ) {
          times.push ( new Date ( data.value.transmitted ).getTime () );
          return [
            data.value.longitude, data.value.latitude
          ];
        };
